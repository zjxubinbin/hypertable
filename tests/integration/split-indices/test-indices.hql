...
SELECT Field2 FROM IndexTest WHERE ROW <= "00001" AND Field2 =^ "1q";
...
SELECT Field2 FROM IndexTest WHERE VALUE Field2 =^ "zfGV";
...
# SELECT * FROM IndexTest WHERE VALUE Field2 =^ "zfGV";
